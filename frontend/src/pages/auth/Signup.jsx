      ...
      <div className="w-full max-w-md animate-scale-in">
        ...
        <form onSubmit={handleSubmit} className="bg-surface rounded-sm p-8 shadow-xl">
          ...
          {[
            ...
            <div key={f.key} className="mb-4">
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-surface border border-slate/20 rounded font-body text-ink focus:outline-none focus:ring-2 focus:ring-brass"
              />
            </div>
          ))}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-indigo text-cream py-2.5 rounded font-medium hover:bg-indigo/90 transition-colors disabled:opacity-50 mt-2"
          >
